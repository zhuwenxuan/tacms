...
var Validate = {
    ...
    Numericality: function(value, paramsObj){
        ...
        var notANumberMessage = paramsObj.failureMessage || "必须是数字!";
        var notAnIntegerMessage = paramsObj.failureMessage || "必须是整数!";
    	var wrongNumberMessage = paramsObj.failureMessage || "必须是 " + is + "!";
    	var tooLowMessage = paramsObj.failureMessage || "不能小于 " + minimum + "!";
    	var tooHighMessage = paramsObj.failureMessage || "不能大于 " + maximum + "!";
